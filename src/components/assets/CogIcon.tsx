export default function CogIcon({ width, height, fill, className }: { width: number, height: number, fill: string, className?: string }) {
   return (
      <svg className={className} version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
         width={width} height={height} viewBox="0 0 64 64" enableBackground="new 0 0 64 64" xmlSpace="preserve">
         <path fill={fill} d="M60.002,20.026h-7.331l3.517-6.096c1.099-1.899,0.446-4.322-1.449-5.417L40.997,0.58
